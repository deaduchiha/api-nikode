...
<ApiTester
  ...
  method="GET"
  title="Test Access Levels"
  description="Test different access levels and see how permissions affect responses"
...
<ApiTester
  ...
  description="Test role-based permissions by trying to create users with different access levels"
  showAuthSection={true}
  defaultApiKey="demo-api-key-123"
  defaultBody={{
    username: "test_user",
