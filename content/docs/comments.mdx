...
```bash
curl "https://api.nikode.com/api/comments?page=1&limit=10&characterId=char_1&status=approved"
```
...
```bash
curl "https://api.nikode.com/api/comments/comment_1"
```
...
```bash
curl -X DELETE "https://api.nikode.com/api/comments/comment_1"
```
...
# Get all comments
response = requests.get('https://api.nikode.com/api/comments')
...
```bash
# Get all comments
curl "https://api.nikode.com/api/comments"

# Get comments with filtering
curl "https://api.nikode.com/api/comments?characterId=char_1&status=approved&sortBy=createdAt&sortOrder=desc"
