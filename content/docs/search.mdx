...
```bash
curl "https://api.nikode.com/api/search?q=naruto&type=characters&page=1&limit=10"
```
...
curl "https://api.nikode.com/api/search?q=goku&type=characters"

# Search for characters by anime
curl "https://api.nikode.com/api/search?q=dragon&type=characters"

# Search for powerful characters
curl "https://api.nikode.com/api/search?q=power&type=characters&sortBy=power&sortOrder=desc"
```
...
curl "https://api.nikode.com/api/search?q=admin&type=users"

# Search for users by role
curl "https://api.nikode.com/api/search?q=moderator&type=users"
```
...
curl "https://api.nikode.com/api/search?q=amazing&type=comments"

# Search for approved comments
curl "https://api.nikode.com/api/search?q=great&type=comments&status=approved"
```
...
curl "https://api.nikode.com/api/search?q=naruto&type=all"

# Search with pagination
curl "https://api.nikode.com/api/search?q=anime&page=2&limit=20"
```
...
curl "https://api.nikode.com/api/search?q=anime&type=all&page=1&limit=10&sortBy=relevance&sortOrder=desc"
```
